<script lang="ts">
    ...
    items = [
        ...
        },
        {
            ...
            answer:
                'You can use Indobase Sites for free on the Free plan, which includes unlimited sites per project. If you need more resources, you can upgrade to a Pro plan. For customers in India, pricing starts at ₹1,999 a month and includes unlimited sites. Learn more about Indobase\'s pricing plans on the <a href="/pricing" class="underline">pricing page</a>.'
        },
        {
