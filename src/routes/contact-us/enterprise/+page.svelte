...
<div class="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
    <div
        ...
        style="background-image: radial-gradient(ellipse 390px 50px at 10% 30%, rgba(255, 219, 88, 0.2) 0%, rgba(255, 219, 88, 0) 70%), radial-gradient(ellipse 1100px 170px at 15% 40%, rgba(255, 219, 88, 0.08) 0%, rgba(255, 219, 88, 0) 70%), radial-gradient(ellipse 1200px 180px at 30% 30%, rgba(255, 219, 88, 0.08) 0%, rgba(255, 219, 88, 0) 70%); background-position: 0% 0%;"
    ></div>
</div>
