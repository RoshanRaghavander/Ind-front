...
>
    <div class="space-y-3 px-3 pt-2 pb-4">
        <div class="flex items-center gap-2">
            <div class="flex size-7 items-center justify-center rounded-lg bg-[#FFDB58]/10">
                <svg width="18" height="18" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20.61 22.27 L34.92 28.63 A1.5 1.5 0 0 1 34.92 31.37 L20.61 37.73 A1.5 1.5 0 0 1 19.39 37.73 L5.08 31.37 A1.5 1.5 0 0 1 5.08 28.63 L19.39 22.27 A1.5 1.5 0 0 1 20.61 22.27 Z" fill="#000000" stroke="#FFDB58" stroke-width="2"/>
                    ...
                    <path d="M20.61 2.27 L34.92 8.63 A1.5 1.5 0 0 1 34.92 11.37 L20.61 17.73 A1.5 1.5 0 0 1 19.39 17.73 L5.08 11.37 A1.5 1.5 0 0 1 5.08 8.63 L19.39 2.27 A1.5 1.5 0 0 1 20.61 2.27 Z" fill="#FFDB58"/>
                </svg>
            </div>
            <h3 class="font-aeonik-pro text-label text-primary">Indobase</h3>
        </div>
        <p class="text-sub-body text-primary max-w-lg font-medium">
            <span class="text-secondary">India's full-stack launch platform</span> for builders who
            want a no-code builder and production backend in one place.
        </p>
    </div>
    <div
    ...
    >
        ...
        <div class="relative flex h-full w-full items-center justify-center">
            ...
            >
                <svg width="140" height="70" viewBox="0 0 40 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20.61 2.27 L34.92 8.63 A1.5 1.5 0 0 1 34.92 11.37 L20.61 17.73 A1.5 1.5 0 0 1 19.39 17.73 L5.08 11.37 A1.5 1.5 0 0 1 5.08 8.63 L19.39 2.27 A1.5 1.5 0 0 1 20.61 2.27 Z" fill="#000000" stroke="#FFDB58" stroke-width="1.6"/>
                </svg>
        ...
        >
            ...
            <div class="bg-[#FFDB58] absolute right-0 bottom-0 rounded-r-md rounded-bl-md px-2 py-0.5 font-medium text-black text-xs">
